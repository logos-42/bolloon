...
这个目录包含 boll-dev skill 的代码示例，展示流形/WOWOK 生态系统的工程实践。
...
```bash
cd /Users/nature/个人项目/boll/.claude/skills/boll-dev/examples
...
- **boll-dev SKILL.md**：完整的工程主管指南
- **arch skill**：架构理念和设计原则
- **ARCHITECTURE_DESIGN.md**：流形网络技术架构
- **MEMORY.md**：项目关键决策记录

## 问题反馈

如果你对这些示例有疑问，或者想看更多示例：
1. 问 boll-dev：代码实现、工程实践、测试策略
